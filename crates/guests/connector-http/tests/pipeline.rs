...
fn seeded_resolver(host: &str, path: &str, target: ResourceTarget) -> ResolverHandle {
    Arc::new(tokio::sync::Mutex::new(TestRouteResolver::with_cached_route(
        host, path, target,
    )))
}
...
// ---------------------------------------------------------------------------
// Golden path (task 4.1 at the HTTP level)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Pipelined keep-alive (task 4.2): distinct tags, ordered responses
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Backpressure (task 4.3): full window stops socket reads, resumes, no loss
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Routing: 404 without dispatch; eviction on connect failure
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Chunked request bodies (upload) and streamed responses (download)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Edge limits: oversized requests get a typed 413
// ---------------------------------------------------------------------------
